...
c) Divida el archivo anterior en 10 partes iguales y corra `cuenta.x` en cada una de las partes. Cuánto se demora en correr en las 10 partes por separado? Haga el mismo ejercicio diviendo el archivo en 20, 50 y 100 partes. Resuma sus resultados en una gráfica del tiempo que toma procesar cada parte como función del número de partes en el que se dividió el archivo original.
