...
b) Escriba un programa en C o C++ (`integra.c`) que al ejecutarse como
 ...
 `N` puntos para calcular una integral por métodos Monte Carlo (ver https://github.com/ComputoCienciasUniandes/MetodosComputacionalesAvanzados/blob/master/secciones/05.MCMC/01_Motivacion_Integracion.ipynb).
