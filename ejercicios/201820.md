...
b. Utilizando los datos de `Default` construya una curva de precision-recall (http://scikit-learn.org/stable/auto_examples/model_selection/plot_precision_recall.html). *Escriba su propia función. No utilice la de sklearn*
